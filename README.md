...
Минималистичная классическая тема WordPress без сайдбара. Шапка, подвал, блог, записи и страницы настраиваются в Customizer. Серый canvas, белые контентные блоки с гибкой шириной. Gutenberg — для контента записей и страниц.
